...
Every release includes `attributions.json` and a human-readable attribution page.
...
University of Dundee, link to CC BY 4.0, and state that the data was adapted. Exclude the separately
licensed images.
